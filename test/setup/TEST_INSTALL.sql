...
BEGIN
  ...
  ASSERT pgm_objects[42] = 'init;text;schemaname text DEFAULT ''public''::text, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text, log_old_data boolean DEFAULT true, log_new_data boolean DEFAULT false, log_state boolean DEFAULT false, trigger_create_table boolean DEFAULT false, except_tables text[] DEFAULT ''{}''::text[], skip_schema_event_triggers boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[84] = 'start;text;schemaname text DEFAULT ''public''::text, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text, log_old_data boolean DEFAULT true, log_new_data boolean DEFAULT false, trigger_create_table boolean DEFAULT false, except_tables text[] DEFAULT ''{}''::text[], skip_schema_event_triggers boolean DEFAULT false', 'Error: Expected different function and/or arguments';
